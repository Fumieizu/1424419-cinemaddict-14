...
const createFilmPopup = ({poster, title, originalName, comments, rating, director, description, year, time, writers, ageRate, actor, genre, country, isFavorites, isWatched, isHistory}) => {
